Feature: CAMARA Network Traffic Analysis API v0.2.0-rc.1 - Operation getTrafficAnalysis
  ...
  Background: Common getTrafficAnalysis setup
    ...
    And the resource "/network-traffic-analysis/v0.2rc1/traffic-analysis"
