Feature: CAMARA Network Traffic Analysis API v0.1.0-alpha.1 - Operation network_traffic_analysis
    ...
    #
    # References to OAS spec schemas refer to schemas specifies in network-traffic-analysis.yaml, version v0.1.0-alpha.1
